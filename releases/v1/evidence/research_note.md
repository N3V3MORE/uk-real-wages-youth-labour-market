...
The 22-29 ASHE result is steadier. Baseline real weekly earnings are up 3.57% from 2019 to 2025, and the decomposition shows hourly pay doing most of the work. A05 shows the 16-24 unemployment gap has widened by 3.70 percentage points versus 25-34 relative to the mean of 2019 rolling-period baseline; the inactivity gap has widened by 2.68 points.
...
A05 is not an earnings source, but it helps describe labour-market pressure around young people. The latest A05 output shows the 16-24 unemployment gap versus 25-34 has widened by 3.70 percentage points relative to the mean of 2019 rolling-period baseline. The inactivity gap has widened by 2.68 percentage points.
