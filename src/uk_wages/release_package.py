...
def build_release_package(
    ...
    temporary_root = release_root / f".evidence-{uuid4().hex}"
    # The staged directory becomes the public package. Inherit project permissions;
    # mkdtemp's private Windows ACL can otherwise prevent the user or Git reading it.
